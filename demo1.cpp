...
void aboutdev(){
	...
	cout<<"\n================";
	cout<<"\n Source code originally made by AdityaKumar \nJust an another COMPUTER SCIENCE GUY who loves machines more than human begin \nsuch a psyche!!";
...
class pl {
	...
	gotoxy(WIN_WIDTH + 2, 16);cout<<" Spacebar = Vaccine Splash";
